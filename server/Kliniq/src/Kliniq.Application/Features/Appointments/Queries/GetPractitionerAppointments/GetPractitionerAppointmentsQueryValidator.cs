...
{
    public sealed class GetPractitionerAppointmentsQueryValidator : AbstractValidator<GetPractitionerAppointmentsQuery>
    {
        public GetPractitionerAppointmentsQueryValidator()
        {
