...
namespace Kliniq.Application.Features.Appointments.Commands.ConfirmAppointment
{
    public sealed record ConfirmAppointmentCommand(Guid AppointmentId) : IRequest<Result<AppointmentDto>>;

    public sealed class ConfirmAppointmentCommandHandler : IRequestHandler<ConfirmAppointmentCommand, Result<AppointmentDto>>
    {
        private readonly IAppointmentRepository _repository;
        private readonly IUnitOfWork _unitOfWork;

        public ConfirmAppointmentCommandHandler(IAppointmentRepository repository, IUnitOfWork unitOfWork)
        {
